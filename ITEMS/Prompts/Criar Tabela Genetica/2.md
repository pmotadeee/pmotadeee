Considere o contexto e me de em md e leia os arquivos do 1 ao 10
...
me de a tabela completa com as instrucoes de como o llm deve ler com as 600 linhas
...
IDLayer1_StyleENTITYImpactLayer2_ArchetypeLayer3_DomainLayer4_ValenceLayer5_StrategyInfluence_WeightConflict_StatusActivation_Phrase_1Activation_Phrase_2
...
[Extract 2 activation phrases from the files that capture the immediate context or character actions. Examples: "The user is debating ethics in AI," "The characters explore Jungian shadow concepts."]
me de a tabela completa com as instrucoes de como o llm deve ler
---
todas as duas ultimas colunas devem ser diferentes, noa podendo se repetir e sendo geradas por vc derivado dos arquivos.
me de a tabela completa com as instrucoes de como o llm deve ler com as 600 linhas
**TABLE FORMAT (HEADER EXAMPLE):**

ME DE AS 600 Linhas
| ID | Layer1_Style | ENTITY | Impact | Layer2_Archetype | Layer3_Domain | Layer4_Valence | Layer5_Strategy | Weight_Influence | Conflict_Status | Activation_Phrase_1 | Activation_Phrase_2 
...
IDLayer1_StyleENTITYImpactLayer2_ArchetypeLayer3_DomainLayer4_ValenceLayer5_StrategyInfluence_WeightConflict_StatusActivation_Phrase_1Activation_Phrase_2
**COLUMN DETAILS:**
- **ID:** Unique identifier for each entity (1 to 600).
...
- **Activation_Phrase_1,2:** Extracted local context phrases.
...
**EXPECTED OUTPUT:**
- A table with 600 rows (entities) filled with data extracted from the files.
