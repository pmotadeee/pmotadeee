...
Filosófico/Existencial (questões cósmicas)
...
2. EXTRAIA padrões de comunicação, temas recorrentes, arquétipos ativos
3. MAPEIE cada interação nas 5 camadas acima
4. CRIE uma tabela onde cada linha representa uma "entidade arquetípica" ativa
5. PARA cada entidade, determine sua posição em cada camada
...
- Domínios complementares formam alianças
- Estilos comunicacionais similares se reforçam
